    ...
    if ids is not None and len(ids) > 0:
        ...
        for i, marker_id in enumerate(ids):
            ...
            if area[0] > aruco_area_threshold:
                ...
                rvec, tvec, _ = cv2.aruco.estimatePoseSingleMarkers(corners[i], 0.02, size_of_aruco_m , dist_mat)
    ...
    def depthimagecb(self, data):
        ...
        if ids is not None: 
            ...
            for marker_id in ids:
                ...
                if self.depth_image is None:
                     print('no depth')
                distance_from_rgb = frame[int(center_aruco_list[i][1])][int(center_aruco_list[i][0])] / 1000
