...
def pose_estimation(frame, aruco_dict_type, matrix_coefficients, distortion_coefficients):
    ...
    image=aruco_display(corners, ids, rejected_img_points, img)
...
cam_mat = np.array(((933.15867, 0, 657.59),(0,933.1586, 400.36993),(0,0,1)))
dist_mat = np.array((-0.43948,0.18514,0,0))
...
while cap.isOpened():
    ...
    output = pose_estimation(img, ARUCO_DICT[aruco_type], cam_mat, dist_mat)
