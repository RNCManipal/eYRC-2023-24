    ...
    def process_image(self):
        ...
        if ids is not None: 
		    ...
		    #we can use self.get_clock().now() instead of  rclpy.Time()
                    ...
                    print("z: ",base_to_obj.transform.translation.z)
                    ...
                    q1_inv=[base_to_obj.transform.rotation.x,base_to_obj.transform.rotation.y,base_to_obj.transform.rotation.z,-base_to_obj.transform.rotation.w]
                    # q2=np.array([0.0,0.0,0.0,1.0])
                    q2=list(tf_transformations.quaternion_from_euler(0,-1.57,0))
                    
                    # q1_inv[0] = base_to_obj.transform.rotation.x
                    # q1_inv[1] = base_to_obj.transform.rotation.y
                    # q1_inv[2] = base_to_obj.transform.rotation.z
                    # q1_inv[3] = -base_to_obj.transform.rotation.w # Negate for inverse
                    ...
                    print("Rotation req: ",qr)
                    
                    q1=[base_to_obj.transform.rotation.x,base_to_obj.transform.rotation.y,base_to_obj.transform.rotation.z,base_to_obj.transform.rotation.w]
                    rot_quat=quaternion_multiply(q1,qr)
                    ...
                    obj_tf_msg.child_frame_id ='obj_' + str(ids[i])
                    # obj_tf_msg.transform = base_to_obj.transform

                    obj_tf_msg.transform.translation.x = base_to_obj.transform.translation.x
                    obj_tf_msg.transform.translation.y = base_to_obj.transform.translation.y
                    obj_tf_msg.transform.translation.z = base_to_obj.transform.translation.z
                    obj_tf_msg.transform.rotation.x = rot_quat[0]
                    obj_tf_msg.transform.rotation.y = rot_quat[1]
                    obj_tf_msg.transform.rotation.z = rot_quat[2]
                    obj_tf_msg.transform.rotation.w = rot_quat[3]
            ...
            print("multiple box val: ")
            print(multi_box_coordinates)
