...
def detect_aruco(image):
    ...
    if ids is not None and len(ids) > 0:
        ...
        for i, marker_id in enumerate(ids):
            ...
            if area[0] > aruco_area_threshold:
                ...
                # Draw frame axes
                rvec, tvec, _ = cv2.aruco.estimatePoseSingleMarkers(corners[i], 0.02, cam_mat, dist_mat)
                cv2.drawFrameAxes(image_1, cam_mat, dist_mat, rvec, tvec,0.1)
    ...
    return center_aruco_list, distance_from_rgb_list, angle_aruco_list, width_aruco_list, ids, image_1
...
class aruco_tf(Node):
    ...
    def process_image(self):
        ...
        #print(self.cv_image)
        center_aruco_list, distance_from_rgb_list, angle_aruco_list, width_aruco_list, ids, image_1= detect_aruco(self.cv_image)
        print("ids:", ids)
        ...
        if ids is not None: 
            ...
            for marker_id in ids:
                ...
                cv2.circle(image_1, center_aruco_list[marker_id], 5, (0, 0, 255), -1)
